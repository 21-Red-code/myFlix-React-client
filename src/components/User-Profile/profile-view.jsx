...
export class ProfileView extends React.Component {
    ...
    editUser = (e) => {
        ...
        axios
            .put(
                `https://good-movies-origin.herokuapp.com/users/${Username}`,
                {
    ...
    onRemoveFavorite = (e, movie) => {
        ...
        axios
            .put( 
                `https://good-movies-origin.herokuapp.com/users/${Username}/FavMovies/${movie._id}`,
                {
                    headers: { Authorization: `Bearer ${token}` },
                }
            )
    ...
    onDeleteUser() {
        ...
        axios
            .delete(`https://good-movies-origin.herokuapp.com/users/${Username}`, {
                headers: { Authorization: `Bearer ${token}` },
            })
            .then((response) => {
                console.log(response);
